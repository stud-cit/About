						...
						<v-window v-model="curStaff">
							...
							>
								<v-card class="mx-auto" color="transparent" width="100%" flat>
									...
									/>
									<div class="card-addition">
										<v-btn icon color="white" class="scroll-icon-left">
											<v-icon size="200" @click="() => switchSlide(false)"
										...
										<v-btn icon color="white" class="scroll-icon-right">
											<v-icon size="200" @click="() => switchSlide(true)"
