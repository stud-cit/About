      ...
      <v-col cols="12" sm="10">
        ...
        <v-row justify="start" class="d-none d-md-flex">
          ...
          >
            ...
            >
              <v-img :height="isMdAndUp ? '300px' : '45%'" :src="getDynamicAssets(person.img_src)"></v-img>
            </v-card>
        ...
        <v-row class="d-flex d-md-none staff-slider" justify="center" align="center">
          <v-col class="staff-slide">
            <v-window v-model="curStaff">
              <v-window-item v-for="(person, i) in ourStaff[$i18n.locale].representation" :key="i">
