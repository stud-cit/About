<template>
  <v-card>
    <ValidationObserver v-slot="{ invalid }" ref="observer" tag="form" @submit.prevent="onSubmit">
      ...
      <v-card-actions>
        ...
        <v-spacer />
        <v-btn :disabled="invalid" @click="onSubmit" depressed color="primary">Login</v-btn>
      </v-card-actions>
    </ValidationObserver>
  </v-card>
</template>
